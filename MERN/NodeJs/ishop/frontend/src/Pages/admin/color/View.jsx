...
export default function View() {
    const { showToast, showConfirmation, color, fetchColor, API_BASE_URL, COLOR_URL } = useContext(Context);
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Color</a>
                        </div>
                    </li>
                </ol>
            </nav>
                    ...
                    <tbody>
                        {
                            ...
                            color.map(
                                (col) => {
                                    return <tr key={col._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <th
                                            scope="row"
                                        ...
                                        <td className="px-6 py-4">
                                            {
                                                col.status
                                                    ? <button className='p-3 bg-green-800 text-white'>
                                                        Active
                                                    </button>
                                                    : <button className='p-3 bg-orange-800 text-white'>
                                                        Inactive
                                                    </button>
                                            }
                                        </td>
