...
export default function Edit() {
    const { API_BASE_URL, showToast, CATEGORY_URL, fetchCategory, category } = useContext(Context);
    ...
    const submitHandler = (e) => {
        ...
        formData.append("category_image", e.target.category_image.files[0] ?? null);

        axios.put(
            API_BASE_URL + CATEGORY_URL + "/edit/" + category_id,
            formData
        ).then(
            (success) => {
    ...
    return (
        <div className='m-3 p-3 shadow-lg py-5 rounded'>
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className="mb-5">
                    Current Image
                    <img src={API_BASE_URL + "/images/category/" + category?.image_name} alt="" />
                </div>
