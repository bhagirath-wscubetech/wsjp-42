...
export default function Edit() {
    ...
    const { fetchProduct, product, API_BASE_URL, fetchCategory, category, fetchColor, color, showToast, PRODUCT_URL } = useContext(Context);
    ...
    const submitHandler = (e) => {
        ...
        formData.append("category", sel_cat.value);
        ...
        const colorIds = sel_colors.map((c) => c.value);
            ...
            <form onSubmit={submitHandler}>
                <div className="grid gap-3 grid-cols-2">
                    <div className="mb-5">
                        ...
                        <input defaultValue={product?.name} ref={nameRef} onChange={convertToSlug} type="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div className="mb-5">
                        <label htmlFor="slug" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Slug</label>
                        <input defaultValue={product?.slug} readOnly ref={slugRef} type="text" id="slug" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                </div>
                <div className="grid gap-3 grid-cols-3">
                    <div className="mb-5">
                        ...
                        <input defaultValue={product?.original_price} onChange={calfinalPrice} ref={originalPriceRef} type="number" id="original_price" name='original_price' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div className="mb-5">
                        <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Discount Percentage</label>
                        <input defaultValue={product?.discount_percentage} onChange={calfinalPrice} ref={discountPerRef} name='discount_percent' type="number" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div className="mb-5">
                        <label htmlFor="final_price" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Final Price</label>
                        <input defaultValue={product?.final_price} ref={finalPriceRef} readOnly type="final_price" id="final_price" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                </div>
